...
export const getCustomerLedger = async (req: Request, res: Response) => {
  ...
  if (salesError) {
    console.error('Failed to fetch credit sales:', salesError);
  ...
  if (returnsError) {
    console.error('Failed to fetch returns:', returnsError);
...
export const recordPayment = async (req: Request, res: Response) => {
  ...
  // Update customer balance - ONLY update credit_balance field
  ...
  console.log('Customer balance updated successfully:', updatedCustomer);
