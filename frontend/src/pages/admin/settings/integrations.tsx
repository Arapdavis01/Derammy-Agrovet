      ...
      <div className={styles.card}>
        ...
        <div className="mt-4">
          <label className="flex items-center gap-2">
            <input
              type="checkbox"
              checked={mpesaConfig.enableStkPush}
              onChange={(e) => handleChange('enableStkPush', e.target.checked)}
            />
            Enable STK Push
          </label>
          <label className="flex items-center gap-2 mt-2">
            <input
              type="checkbox"
              checked={mpesaConfig.enableC2B}
              onChange={(e) => handleChange('enableC2B', e.target.checked)}
            />
